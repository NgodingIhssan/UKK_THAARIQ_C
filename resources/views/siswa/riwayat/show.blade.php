        ...
        <div class="row">
            <div class="col-md-6">
                <table class="table table-bordered">
                    <tr><th width="40%">Tanggal Pinjam</th><td>{{ \Carbon\Carbon::parse($transaksi->tgl_pinjam)->format('d/m/Y H:i') }}</td></tr>
                    ...
                    <tr><th>Tanggal Kembali</th><td>{{ \Carbon\Carbon::parse($transaksi->tgl_kembali)->format('d/m/Y H:i') }}</td></tr>
                    @endif
                    <tr><th>Status</th>
                        <td>
                            @php
            ...
            <div class="col-md-6">
                <table class="table table-bordered">
                    ...
                    <tr><th>Denda</th><td class="text-danger">Rp {{ number_format($transaksi->denda_total, 0, ',', '.') }}</td></tr>
                </table>
            </div>
        </div>
        
        <h4 class="mt-3">Detail Barang yang Dipinjam</h4>
